...
namespace Octokit
{
    ...
    public class IssueCommentReactionsClient : ApiClient, IIssueCommentReactionsClient
    {
        ...
        [ManualRoute("POST", "/repos/{owner}/{repo}/issues/comments/{commentId}/reactions")]
        ...
        /// <param name="commentId">The comment id</param>
        /// <param name="reaction">The reaction to create</param>
        [ManualRoute("POST", "/repositories/{0}/issues/comments/{commentId}/reactions")]
        ...
        /// <param name="repositoryId">The Id of the repository</param>
        /// <param name="commentId">The comment id</param>
        [ManualRoute("GET", "/repositories/{0}/issues/comments/{commentId}/reactions")]
        ...
        /// <returns></returns>
        [ManualRoute("DELETE", "/repos/{owner}/{repo}/issues/comments/{commentId}/reactions/{reaction_id}")]
        ...
        /// <param name="reactionId">The reaction id</param>
        /// <returns></returns>
        [ManualRoute("DELETE", "/repositories/{id}/issues/comments/{commentId}/reactions/{reaction_id}")]
