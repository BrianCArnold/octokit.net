...
namespace Octokit
{
    ...
    public class PullRequestReviewCommentReactionsClient : ApiClient, IPullRequestReviewCommentReactionsClient
    {
        ...
        [ManualRoute("GET", "/repos/{owner}/{repo}/pulls/comments/{commentId}/reactions")]
        ...
        /// <param name="commentId">The comment id</param>
        [ManualRoute("GET", "/repositories/{id}/pulls/comments/{commentId}/reactions")]
        ...
        [ManualRoute("POST", "/repos/{owner}/{repo}/pulls/comments/{commentId}/reactions")]
        ...
        /// <param name="commentId">The comment id</param>
        /// <param name="reaction">The reaction to create</param>
        [ManualRoute("POST", "/repositories/{id}/pulls/comments/{commentId}/reactions")]
        ...
        /// <returns></returns>
        [ManualRoute("DELETE", "/repos/{owner}/{repo}/pulls/comments/{commentId}/reactions/{reaction_id}")]
        ...
        /// <param name="reactionId">The reaction id</param>
        /// <returns></returns>
        [ManualRoute("DELETE", "/repositories/{id}/pulls/comments/{commentId}/reactions/{reaction_id}")]
