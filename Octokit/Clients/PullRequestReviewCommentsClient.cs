...
namespace Octokit
{
    ...
    public class PullRequestReviewCommentsClient : ApiClient, IPullRequestReviewCommentsClient
    {
        ...
        /// <param name="owner">The owner of the repository</param>
        /// <param name="name">The name of the repository</param>
        /// <param name="commentId">The pull request review comment number</param>
        [ManualRoute("GET", "/repos/{owner}/{repo}/pulls/comments/{commentId}")]
        ...
        /// <param name="repositoryId">The Id of the repository</param>
        /// <param name="commentId">The pull request review comment number</param>
        [ManualRoute("GET", "/repositories/{id}/pulls/comments/{commentId}")]
        ...
        [ManualRoute("PATCH", "/repos/{owner}/{repo}/pulls/comments/{commentId}")]
        ...
        /// <param name="commentId">The pull request review comment number</param>
        /// <param name="comment">The edited comment</param>
        [ManualRoute("PATCH", "/repositories/{id}/pulls/comments/{commentId}")]
        ...
        /// <param name="name">The name of the repository</param>
        /// <param name="commentId">The pull request review comment number</param>
        [ManualRoute("DELETE", "/repos/{owner}/{repo}/pulls/comments/{commentId}")]
        ...
        /// <param name="repositoryId">The Id of the repository</param>
        /// <param name="commentId">The pull request review comment number</param>
        [ManualRoute("DELETE", "/repositories/{id}/pulls/comments/{commentId}")]
