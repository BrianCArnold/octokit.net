...
namespace Octokit
{
    ...
    public class CommitCommentReactionsClient : ApiClient, ICommitCommentReactionsClient
    {
        ...
        /// <returns></returns>
        [ManualRoute("POST", "/repos/{owner}/{repo}/comments/{commentId}/reactions")]
        ...
        /// <param name="reaction">The reaction to create</param>
        /// <returns></returns>
        [ManualRoute("POST", "/repositories/{id}/comments/{commentId}/reactions")]
        ...
        /// <param name="commentId">The comment id</param>
        /// <returns></returns>
        [ManualRoute("GET", "/repos/{owner}/{repo}/comments/{commentId}/reactions")]
        ...
        /// <param name="commentId">The comment id</param>
        /// <returns></returns>
        [ManualRoute("GET", "/repositories/{id}/comments/{commentId}/reactions")]
        ...
        /// <returns></returns>
        [ManualRoute("DELETE", "/repos/{owner}/{repo}/comments/{commentId}/reactions/{reaction_id}")]
        ...
        /// <param name="reactionId">The reaction id</param>
        /// <returns></returns>
        [ManualRoute("DELETE", "/repositories/{repositoryId}/comments/{commentId}/reactions/{reaction_id}")]
