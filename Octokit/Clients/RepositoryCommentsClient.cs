...
namespace Octokit
{
    ...
    public class RepositoryCommentsClient : ApiClient, IRepositoryCommentsClient
    {
        ...
        [ManualRoute("GET", "/repos/{owner}/{repo}/comments/{commentId}")]
        ...
        /// <remarks>http://developer.github.com/v3/repos/comments/#get-a-single-commit-comment</remarks>
        [ManualRoute("GET", "/repositories/{id}/comments/{commentId}")]
        ...
        [ManualRoute("PATCH", "/repos/{owner}/{repo}/comments/{commentId}")]
        ...
        /// <param name="commentUpdate">The modified comment</param>
        /// <remarks>http://developer.github.com/v3/repos/comments/#update-a-commit-comment</remarks>
        [ManualRoute("PATCH", "/repositories/{id}/comments/{commentId}")]
        ...
        [ManualRoute("DELETE", "/repos/{owner}/{repo}/comments/{commentId}")]
        ...
        /// <param name="commentId">The comment id</param>
        /// <remarks>http://developer.github.com/v3/repos/comments/#delete-a-commit-comment</remarks>
        [ManualRoute("DELETE", "/repositories/{id}/comments/{commentId}")]
